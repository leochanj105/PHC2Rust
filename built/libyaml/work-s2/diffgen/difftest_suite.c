...
int main(void)
{
    ...
    run_test("string_extend", test_string_extend, 2);
    run_test("string_join", test_string_join, 2);
    run_test("stack_extend", test_stack_extend, 2);
    run_test("queue_extend", test_queue_extend, 2);
    run_test("token_delete", test_token_delete, 2);
    run_test("events_initialize", test_events_initialize, 2);
    ...
    run_test("emitter_emit", test_emitter_emit, 2);
    ...
    run_test("bridge_emitter_error", test_bridge_emitter_error, 2);
    run_test("bridge_writer_error", test_bridge_writer_error, 2);
    run_test("bridge_need_more_events", test_bridge_need_more_events, 2);
    run_test("bridge_append_tag_directive", test_bridge_append_tag_directive, 2);
    run_test("bridge_increase_indent", test_bridge_increase_indent, 2);
    run_test("bridge_emitter_checks", test_bridge_emitter_checks, 2);
    run_test("bridge_analyze", test_bridge_analyze, 2);
    run_test("bridge_process", test_bridge_process, 2);
    run_test("bridge_write", test_bridge_write, 2);
    run_test("bridge_write_quoted", test_bridge_write_quoted, 2);
    run_test("bridge_write_block", test_bridge_write_block, 2);
    run_test("bridge_generate_anchor", test_bridge_generate_anchor, 2);
    run_test("bridge_parser_errors", test_bridge_parser_errors, 2);
    run_test("bridge_scanner_via_parse", test_bridge_scanner_via_parse, 2);
    run_test("bridge_flow_indent", test_bridge_flow_indent, 2);
    run_test("bridge_roll_unroll_indent", test_bridge_roll_unroll_indent, 2);
    run_test("bridge_simple_keys", test_bridge_simple_keys, 2);
    run_test("bridge_fetch_stream", test_bridge_fetch_stream, 2);
    run_test("bridge_scan_to_next_token", test_bridge_scan_to_next_token, 2);
    ...
    run_test("bridge_emit_stream_start", test_bridge_emit_stream_start, 2);
    run_test("bridge_write_bom", test_bridge_write_bom, 2);
    run_test("bridge_emitter_anchor_node", test_bridge_emitter_anchor_node, 2);
    run_test("bridge_select_scalar_style", test_bridge_select_scalar_style, 2);
    run_test("bridge_delete_doc_anchors", test_bridge_delete_doc_anchors, 2);
    run_test("bridge_delete_aliases", test_bridge_delete_aliases, 2);
    run_test("bridge_maximum_level", test_bridge_maximum_level, 2);
    run_test("bridge_process_empty_scalar", test_bridge_process_empty_scalar, 2);
    run_test("bridge_string_read_partial", test_bridge_string_read_partial, 2);
    run_test("emitter_string_output", test_emitter_string_output, 2);
    run_test("custom_read_handler", test_custom_read_handler, 2);
    run_test("custom_write_handler", test_custom_write_handler, 2);
    run_test("emitter_unicode", test_emitter_unicode, 2);
    run_test("roundtrip", test_roundtrip, 2);
    run_test("scalar_styles", test_scalar_styles, 2);
    run_test("emitter_anchor_alias", test_emitter_anchor_alias, 2);
    run_test("emitter_tagged", test_emitter_tagged, 2);
    run_test("bridge_process_tag", test_bridge_process_tag, 2);
    run_test("bridge_parse_stream_start", test_bridge_parse_stream_start, 2);
    run_test("bridge_process_directives", test_bridge_process_directives, 2);
    run_test("emitter_flow_sequence", test_emitter_flow_sequence, 2);
    run_test("emitter_flow_mapping", test_emitter_flow_mapping, 2);
    run_test("bridge_fetch_directives", test_bridge_fetch_directives, 2);
    run_test("bridge_emitter_dump", test_bridge_emitter_dump, 2);
    run_test("parser_scan_directives", test_parser_scan_directives, 2);
    run_test("bridge_emit_doc", test_bridge_emit_doc, 2);
    run_test("multi_doc_load", test_multi_doc_load, 2);
    run_test("bridge_emit_node", test_bridge_emit_node, 2);
    return 0;
}

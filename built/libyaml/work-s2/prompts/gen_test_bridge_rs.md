...
- **Transpiled Rust library** (where the actual implementations live):
  `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-s2/src/`
...
1. **Use the types and module paths that actually exist in `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-s2/src/`.**
...
3. **Do NOT modify any file other than the output.** You are not allowed to
   edit `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-s2/src/*.rs`. Visibility promotion (making private `fn`
...
4. **Verify the file compiles.** Since you cannot edit `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-s2/`, do
   the verification in a scratch copy:
   - `cp -r /home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-s2 /tmp/bridge_verify`

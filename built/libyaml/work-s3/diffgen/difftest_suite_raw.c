...
int main(void)
{
    ...
    test_scan_tag();
    test_scan_block_scalar();
    test_scan_flow_scalar();
    test_scan_malformed_utf8();
    ...
    test_parse_duplicate_anchor();
    test_parse_undefined_alias();
    test_parse_multi_document();
    test_parse_explicit_document();
    test_parse_version_directive();
    test_parse_tag_directive();
    test_parse_long_scalar();
    test_parse_deep_nest();
    test_parse_flow_sequence();
    test_parse_flow_mapping_ordered();
    test_parse_block_sequence();
    test_parse_indentless_sequence();
    test_parse_null_scalar();
    test_parse_bool_scalar();
    test_parse_int_float();
    test_parse_special_chars();
    test_parse_set_encoding();
    ...
    test_emit_sequence();
    test_emit_mapping();
    test_emit_anchor_alias();
    test_emit_canonical();
    test_emit_scalar_styles();
    test_emit_tag_directive();
    test_emit_version_directive();
    test_emit_unicode();
    test_emit_settings();
    ...
    test_bridge_error_setters();
    test_bridge_parser_internals();
    test_bridge_fetch_stream();
    test_bridge_scanner_scan();
    test_bridge_scan_directives();
    test_bridge_scan_anchor_tag();
    test_bridge_scan_scalars();
    test_bridge_scan_uri_escapes();
    test_bridge_parser_state_machine();
    test_bridge_parse_fns();
    test_bridge_emitter_analyze();
    test_bridge_emitter_checks();
    test_bridge_emitter_indent();
    test_bridge_emitter_append_tag_dir();
    test_bridge_emitter_generate_anchor();
    test_bridge_emitter_write_fns();
    test_bridge_emitter_state_machine();
    test_bridge_emitter_emit_fns();
    test_bridge_emitter_select_style();
    test_bridge_emitter_analyze_event();
    test_bridge_emitter_process_fns();
    test_bridge_loader();
    test_bridge_dumper();
    test_bridge_dump_node();
    test_bridge_reader_writer();

    /* Max nesting */
    test_max_nest_level();

    /* Edge cases */
    test_edge_empty_scalar();
    test_edge_special_float();
    test_edge_multiline_mapping_key();
    test_edge_flow_mapping_empty_value();
    test_edge_block_scalar_chomping();
    test_edge_tag_forms();
    test_edge_long_anchor();
    test_edge_repeated_docs();
    test_edge_nested_flow();

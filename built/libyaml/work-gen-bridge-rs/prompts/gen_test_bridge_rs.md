...
- **C bridge header** (authoritative list of 137 bridge functions to produce):
  `/home/leochanj/Desktop/PHC2Rust/built/libyaml/test_bridge.h`
- **Transpiled Rust library** (where the actual implementations live):
  `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-baseline/src/`
- **Output file** — write the complete result to:
  `/home/leochanj/Desktop/PHC2Rust/built/libyaml/test_bridge.rs`
...
1. **Use the types and module paths that actually exist in `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-baseline/src/`.**
...
2. **All 137 wrappers must be present.** Read `/home/leochanj/Desktop/PHC2Rust/built/libyaml/test_bridge.h` to get the
   full list. Missing any is a failure.

3. **Do NOT modify any file other than the output.** You are not allowed to
   edit `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-baseline/src/*.rs`. Visibility promotion (making private `fn`
...
4. **Verify the file compiles.** Since you cannot edit `/home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-baseline/`, do
   the verification in a scratch copy:
   - `cp -r /home/leochanj/Desktop/PHC2Rust/built/libyaml/rust-baseline /tmp/bridge_verify`
   ...
   - When it builds cleanly, write the final `test_bridge.rs` to
     `/home/leochanj/Desktop/PHC2Rust/built/libyaml/test_bridge.rs` and remove `/tmp/bridge_verify`.

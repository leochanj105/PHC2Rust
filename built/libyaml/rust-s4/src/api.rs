...
pub(crate) unsafe extern "C" fn yaml_string_read_handler(
    data: *mut c_void,
    buffer: *mut c_uchar,
    mut size: size_t,
...
pub(crate) unsafe extern "C" fn yaml_file_read_handler(
    data: *mut c_void,
    buffer: *mut c_uchar,
    size: size_t,
    size_read: *mut size_t,
...
pub(crate) unsafe extern "C" fn yaml_string_write_handler(
    data: *mut c_void,
    buffer: *mut c_uchar,
    size: size_t,
) -> c_int {
...
pub(crate) unsafe extern "C" fn yaml_file_write_handler(
    data: *mut c_void,
    buffer: *mut c_uchar,
    size: size_t,
) -> c_int {
...
pub(crate) unsafe fn yaml_check_utf8(start: *const yaml_char_t, length: size_t) -> c_int {
